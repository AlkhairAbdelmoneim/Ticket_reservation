        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card  box-shadow-0 ">
                ...
                <div class="card-body">
                    ...
                    <form class="___class_+?9___" action="{{ route('department.update' ,$department->id) }}" method="POST"
                        ...
                        <div class="___class_+?9___">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="الاسم" value="{{$department->name}}">
                            </div>
                        </div>
